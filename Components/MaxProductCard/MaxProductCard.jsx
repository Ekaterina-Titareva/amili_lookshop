import styles from './maxProductCard.module.scss'

function MaxProductCard({id, category, name, image1, image2, image3, description, text1, text2, color, size, price, material, selectedImage, handleImageClick}) {
